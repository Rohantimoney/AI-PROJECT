...
def process_resume(pdf_file):
    ...
    with st.spinner("Analyzing your resume... This may take a moment."):
        ...
        try:
            ...
            name_response = llm.invoke(name_extraction_prompt)
...
with st.sidebar:
    ...
    if st.button("Start Interview"):
        if resume_file:
            vector_store, user_name = process_resume(resume_file)
            if vector_store:
                ...
                # Create a personalized greeting and the first question
                ...
                # Combine greeting and first question for the initial message
